...
const RemoteMonitoringSection = () => {
  return (
    <section id="remote-monitoring" className="relative w-full">
      {/* Gradient background wrapper */}
      <div className="gradient-bg p-2">
        <div className="section-container relative min-h-screen flex flex-col items-center px-8 py-12 overflow-hidden rounded-3xl">
          ...
          {/* Tablet mockup */}
          <motion.div
            className="relative z-10 mt-8 w-full max-w-[700px]"
            variants={fadeUp}
            initial="hidden"
            whileInView="visible"
